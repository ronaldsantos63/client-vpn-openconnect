...
class MainWindow(QMainWindow):
    ...
    def check_user(self):
        ...
        if os.environ.get("USER") != "root":
            pass_sudo = QInputDialog.getText(self, "Warning!", "Administrative access is required to run this software", QLineEdit.EchoMode.PasswordEchoOnEdit)
    ...
    def setup_ui(self):
        ...
        l = QVBoxLayout()
        l.addLayout(vpn_url_container)
        l.addLayout(user_container)
        l.addLayout(pass_container)
        l.addLayout(auth_group_container)
        l.addLayout(buttons_container)
